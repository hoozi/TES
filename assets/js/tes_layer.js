...
function login(){
    tesLayer({
        title: '&nbsp;',
        area: ['500px', 'auto'],
        skin: 'tes-layer login-layer',
        content:$.template('temp_login')({})
    })
}
...
function upload(){
    ...
    function render(data){
        var html = $.template('temp_tr')(data)
        $("#grid_add_area").html(html);
    }
    tesLayer({
        title: '上传单证信息',
        area: ['960px', 'auto'],
        skin: 'tes-layer',
        content:$.template('temp_upload')({}),
        success: function(){
            ...
            $("#grid_add_area").on("click", ".J_d_tr", function(){
            ...
            $("#grid_add_area").on("click", "tr", function(){
                $("#grid_add_area>tr").removeClass("selected");
...
function make(){
    $.ajax({
        ...
        tesLayer({
            ...
            area: ['1000px', 'auto'],
            zIndex:100,
            skin: 'tes-layer qp-layer',
            content:html,
            success: function(){
                $(".layui-layer-content").css({"height":$(window).height()-60,"overflow-y":"auto"})
            }
        });
    });
}
